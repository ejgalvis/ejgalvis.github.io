...
function playInstrument(instrumentSound) {
  var sound = new Howl({
    src: [`https://ejgalvis.github.io/Technical_Presentations/Week_5/audio/${instrumentSound}.mp3`, `https://ejgalvis.github.io/Technical_Presentations/Week_5/audio/${instrumentSound}.webm`],
    sprite: {
      Drum: [0, 3000],
      Guitar: [0, 3000],
      Organ: [0, 3000],
